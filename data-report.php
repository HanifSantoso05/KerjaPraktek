                              ...
                              <div class="container">
                                    ...
                                    <table class="table table-hover">
                                          ...
                                          <tbody>
                                                ...
                                                $data = mysqli_query($koneksi, "SELECT * FROM book2 WHERE Coil_Number = '$cari' LIMIT ".$mulai.", ".$halaman);
                                          ...
                                          ?>
                                                ...
                                                $data = mysqli_query($koneksi, "SELECT * FROM book2 WHERE Coil_Number = '$cari'");
                                                }   
