            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="container">
                        ...
                        <div class="row g-4">
                            <div class="col-auto">
                                <a href="data-report.php"><button class="btn btn-warning text-white ">Lihat Data Keseluruhan</button></a>
                            <div>
                        </div>
                        <br>
                        <table class="table table-hover">
                            ...
                            ?>
                                    <tbody>
                                        ...
                                        if($bulan=="" && $tahun=="" && $halaman==10){
                                        $data= mysqli_query($koneksi, "SELECT * FROM book2 LIMIT ".$mulai.",".$halaman);
                                        }else{
                                        //pengkondisian jika parameter kolom pencarian diisi
                                        $data = mysqli_query($koneksi, "SELECT * FROM book2 WHERE (month(tanggal)='$bulan' AND year(tanggal) = '$tahun') LIMIT ".$mulai.", ".$halaman);
                                        echo "<b>Hasil pencarian : $bulan, $tahun</b>";
                                        }
                                ...
                                <div>
                                    <ul class="pagination">
                                        ...
                                        $data = mysqli_query($koneksi, "SELECT * FROM book2 WHERE (month(tanggal)='$bulan' AND year(tanggal) = '$tahun')");
                                        }   
